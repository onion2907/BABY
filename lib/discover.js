...
// Verify one specific RTSP URL returns a real frame (used after ONVIF hands us
// an exact address). Public wrapper over the internal ffmpeg grab.
export function verifyRtsp(url, user, password) {
  return tryRtsp(url, user, password);
}
